...
;* Date/Time created: Sun Jan 23 21:55:03 2022                 *
;***************************************************************
...
;	C:\ti\ccs1100\ccs\tools\compiler\ti-cgt-c2000_21.6.0.LTS\bin\opt2000.exe C:\\Users\\murat\\AppData\\Local\\Temp\\{C023FF89-8A99-48F4-90B3-2516F0901147} C:\\Users\\murat\\AppData\\Local\\Temp\\{67A603C8-F1AA-411C-B8E1-93E78501376E} 
;	C:\ti\ccs1100\ccs\tools\compiler\ti-cgt-c2000_21.6.0.LTS\bin\ac2000.exe -@C:\\Users\\murat\\AppData\\Local\\Temp\\{E33F293E-F10E-4C33-9B75-F89F639D8F2F} 
	.sect	".text"
	.clink
...
;* AL    assigned to $O$C2
	...
	.dwpsn	file "../resolver.c",line 156,column 5,is_stmt,isa 0
        MOVL      ACC,@$BLOCKED(_rslvrOut)+26 ; [CPU_ALU] |156| 
...
$C$L3:    
	...
	.dwpsn	file "../resolver.c",line 169,column 10,is_stmt,isa 0
        ...
        MOVW      DP,#_rslvrOut+26      ; [CPU_ARAU] 
        CMPL      ACC,@$BLOCKED(_rslvrOut)+26 ; [CPU_ALU] |169| 
...
$C$L5:    
	...
	.dwpsn	file "../resolver.c",line 174,column 5,is_stmt,isa 0
        MOV       ACC,@$BLOCKED(_rslvrOut)+24 ; [CPU_ALU] |174| 
...
||      MOV32     R5H,@$BLOCKED(_rslvrIn)+10 ; [CPU_FPU] |137| 
	...
	.dwpsn	file "../resolver.c",line 137,column 2,is_stmt,isa 0
        ...
        MOV32     @$BLOCKED(_rslvrIn)+12,R1H ; [CPU_FPU] |137| 
||      MPYF32    R2H,R3H,R0H           ; [CPU_FPU] |139| 

	.dwpsn	file "../resolver.c",line 139,column 2,is_stmt,isa 0
        MOV32     R1H,@$BLOCKED(_rslvrIn)+10 ; [CPU_FPU] |139| 
...
||      MOV32     R0H,@_rslvrKp         ; [CPU_FPU] |141| 
	...
	.dwpsn	file "../resolver.c",line 140,column 2,is_stmt,isa 0
        ...
        MOV32     @$BLOCKED(_rslvrIn)+14,R2H ; [CPU_FPU] |140| 
||      ADDF32    R0H,R0H,R1H           ; [CPU_FPU] |141| 
	...
	.dwpsn	file "../resolver.c",line 141,column 2,is_stmt,isa 0
        MOV32     @$BLOCKED(_rslvrIn)+16,R0H ; [CPU_FPU] |141| 
...
_baseParamsInit:
	...
	.dwpsn	file "../resolver.c",line 118,column 2,is_stmt,isa 0
        MOV32     @$BLOCKED(_rslvrIn)+10,R0H ; [CPU_FPU] |118| 
	...
	.dwpsn	file "../resolver.c",line 119,column 2,is_stmt,isa 0
        MOVB      @$BLOCKED(_rslvrIn)+3,#16,UNC ; [CPU_ALU] |119| 
	.dwpsn	file "../resolver.c",line 127,column 2,is_stmt,isa 0
...
_ResolverISR:
	...
	.dwpsn	file "../resolver.c",line 206,column 2,is_stmt,isa 0
        MOV32     @$BLOCKED(_rslvrOut)+28,R1H ; [CPU_FPU] |206| 
	.dwpsn	file "../resolver.c",line 207,column 2,is_stmt,isa 0
        MOV32     @$BLOCKED(_rslvrOut)+30,R0H ; [CPU_FPU] |207| 
...
$C$DW$41	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../resolver.c",line 213,column 6,is_stmt,isa 0
        MOV       AL,@$BLOCKED(_rslvrIn)+2 ; [CPU_ALU] |213| 
...
$C$DW$42	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../resolver.c",line 219,column 9,is_stmt,isa 0
        ...
        MOV32     R1H,@$BLOCKED(_rslvrIn)+8 ; [CPU_FPU] |219| 
...
$C$L9:    
	...
	.dwpsn	file "../resolver.c",line 219,column 9,is_stmt,isa 0
        MOV32     @$BLOCKED(_rslvrIn)+8,R0H ; [CPU_FPU] |219| 
	.dwpsn	file "../resolver.c",line 222,column 11,is_stmt,isa 0
...
$C$L11:    
	...
	.dwpsn	file "../resolver.c",line 232,column 2,is_stmt,isa 0
        OR        @$BLOCKED(_AdccRegs)+4,#0x0001 ; [CPU_ALU] |232| 
        SUBB      SP,#2                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -26
	...
	.dwpsn	file "../resolver.c",line 233,column 2,is_stmt,isa 0
        MOVB      @$BLOCKED(_PieCtrlRegs)+1,#1,UNC ; [CPU_ALU] |233| 
...
$C$DW$1250	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1250, DW_AT_name("VCRC")
	.dwattr $C$DW$1250, DW_AT_location[DW_OP_regx 0x50]

$C$DW$1251	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1251, DW_AT_name("VSTATUS")
	.dwattr $C$DW$1251, DW_AT_location[DW_OP_regx 0x51]
