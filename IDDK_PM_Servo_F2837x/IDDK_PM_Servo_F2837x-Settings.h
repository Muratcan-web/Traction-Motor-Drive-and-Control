...
#define SINCOS_POS_ENCODER 4
#define ENDAT_POS_ENCODER 5
...
#define RS 		0.9//2.35		    	    // Stator resistance (ohm)
#define RR   			               	// Rotor resistance (ohm)
#define LS   	0.002//0.0065					// Stator inductance (H)
#define LR   			  				// Rotor inductance (H)
#define LM   			   				// Magnatizing inductance (H)
#define POLES  	4//8						// Number of poles
										// Number of poles

// Define the base quantites
#define BASE_VOLTAGE        10//MY236.14    // Base peak phase voltage (volt), Vdc/sqrt(3)
#define BASE_SHUNT_CURRENT    9.95    // Base peak phase current (amp), Max. measurable peak curr.
#define BASE_LEM_CURRENT     100   //  ----- do -----
#define BASE_TORQUE     	//0.25	      // Base torque (N.m)
#define BASE_FLUX       			  // Base flux linkage (volt.sec/rad)
#define BASE_FREQ      50	//MY200           // Base electrical frequency (Hz)


/*------------------------------------------------------------------------------
Current sensors scaling
------------------------------------------------------------------------------*/
// LEM    1.0pu current ==> 100.0A -> 2048 counts ==> 50A -> 1365
...
// ADC Related defines
//MY: commented out hte shunt measurements
...
// ************************************************************************
#define  LEM_TO_SHUNT    100//10.05304   // (12.0/9.945)
